...
module.exports = {
  ...
  getByIndex: async function(listingIndex) {
    const contractData = await this.o2oprotocol.contractService.getListing(listingIndex)
    const ipfsData = await this.o2oprotocol.ipfsService.getFile(contractData.ipfsHash)
  ...
  create: async function(data, schemaType) {
    ...
    return this.o2oprotocol.o2oService.submitListing({ formData: data }, schemaType)
  },

  buy: async function(listingAddress, unitsToBuy, ethToPay) {
    return await this.o2oprotocol.contractService.buyListing(listingAddress, unitsToBuy, ethToPay)
  }
}
