...
/// @title Purchase
/// @dev An purchase O2OProtocol Listing representing a purchase/booking
import "./Listing.sol";


contract Purchase {

  uint private DEFAULT_BUYERTIMEOUT = 21 days;
  ...
  */
  ...
  // Pay for listing
  // We used to limit this to buyer, but that prevents Listing contract from paying
  function pay()
  public
  payable
  ...
  atStage(Stages.SHIPPING_PENDING)
  {
      ...
      buyerTimeout = now + DEFAULT_BUYERTIMEOUT;
      emit PurchaseChange(internalStage);
  }
